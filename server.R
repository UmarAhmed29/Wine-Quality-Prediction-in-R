  ...
  function (input, output) {
    ...
    output$plot1<-renderPlot({
      ...
      plot(wine$fixed.acidity, wine$volatile.acidity,col=cols[wine$quality],pch=20,
           xlab=expression(paste("Fixed Acidity - g/",dm^3,sep="")),
           ylab=expression(paste("Volatile  Acidity - g/",dm^3,sep="")))
    ...
    output$plot2<-renderPlot({
      ...
      plot(wine$citric.acid,wine$pH,col=cols[wine$quality],pch=20,
           ylab="pH",
           xlab=expression(paste("Citric Acid - g/",dm^3,sep="")))
    ...
    output$plot3<-renderPlot({
      ...
      plot(wine$pH, wine$sulphates,col=cols[wine$quality],pch=20,
           xlab="pH",
           ylab=expression(paste("Sulphates - g/",dm^3,sep="")))
    ...
    output$plot4<-renderPlot({
      ...
      plot(wine$residual.sugar, wine$chlorides,col=cols[wine$quality],pch=20,
           xlab=expression(paste("Residual Sugar - g/",dm^3,sep="")),
           ylab=expression(paste("Sodium Chloride - g/",dm^3,sep="")))
    ...
    output$plot5<-renderPlot({
      ...
      plot(wine$free.sulfur.dioxide, wine$total.sulfur.dioxide,col=cols[wine$quality],pch=20,
           xlab=expression(paste("Free Sulfur Dioxide SO2 - mg/",dm^3,sep="")),
